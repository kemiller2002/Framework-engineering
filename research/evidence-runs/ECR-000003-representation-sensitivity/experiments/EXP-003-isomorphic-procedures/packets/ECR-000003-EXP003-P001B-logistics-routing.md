packet_id: ECR-000003-EXP003-P001B
experiment_id: EXP-003
variant_id: P001B
artifact_family_id: P001
recognition_condition: domain_variant_logistics
blinded_artifact_id: BR-EXP003-P001

blinded_procedural_content:

A delivery path is uncertain.

Candidate routes are generated.

Differentiating route information is gathered.

Candidate routes are assessed.

The process loops if route confidence is insufficient.

The process ends when a route is accepted or further search is not justified.
