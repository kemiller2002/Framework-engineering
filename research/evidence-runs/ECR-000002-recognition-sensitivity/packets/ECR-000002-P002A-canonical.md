packet_id: ECR-000002-P002A
artifact_family_id: P002
recognition_condition: canonical
blinded_artifact_id: BR-P002

blinded_procedural_content:

Work items are selected from a prioritized pool for a short, fixed-length cycle.

The team commits to completing the selected work during that cycle.

Daily coordination occurs so participants can surface progress, blockers, and immediate next steps.

The selected work is completed and combined into a demonstrable outcome.

The outcome is inspected with stakeholders or other relevant observers.

The team then reflects on how the cycle was executed and adjusts before beginning the next cycle.
