...
Candidate work is selected for a short bounded interval.

Participants make a short-term commitment around that selected work.

They coordinate frequently during the interval to surface progress, obstacles, and immediate adjustments.

The selected work is carried out and brought to a usable state.

The resulting outcome is then examined.

After that examination, the group reflects on how the cycle operated and adapts before starting the next interval.
