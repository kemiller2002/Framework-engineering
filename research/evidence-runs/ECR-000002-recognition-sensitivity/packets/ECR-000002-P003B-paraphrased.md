...
Activities are organized into ordered levels of increasing difficulty or sophistication.

Lower levels support higher ones.

As a person moves upward through the levels, the expected kind of operation changes.

The structure distinguishes simpler operations from more demanding ones.

This arrangement is mainly classificatory.

It does not by itself require a repeating execution cycle or a decision loop.
