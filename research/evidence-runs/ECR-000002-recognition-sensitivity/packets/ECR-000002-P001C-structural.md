packet_id: ECR-000002-P001C
artifact_family_id: P001
recognition_condition: structural
blinded_artifact_id: BR-P001

blinded_procedural_content:

An unresolved state appears.

Candidate states are produced.

Differentiating information is acquired.

Candidate states are assessed against the acquired information.

The process loops if confidence is insufficient.

The process ends when one candidate is sufficiently supported or continued inquiry is not justified.

Later conflicting information can reopen the process.
