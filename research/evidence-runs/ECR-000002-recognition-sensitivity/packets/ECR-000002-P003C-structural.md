...
Items are organized into ordered levels of increasing complexity.

Lower levels support higher levels.

Movement across levels changes the type of operation expected.

The structure does not itself require execution or decision.

The arrangement is hierarchical rather than cyclical.
